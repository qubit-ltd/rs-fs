...
/// Verifies the facade attaches validated source and target identities to a primitive rename result.
#[test]
...
/// Verifies a provider atomicity downgrade cannot be represented as an unchanged failure.
#[test]
...
/// Verifies copy-and-delete provider output is rejected as a non-rename contract violation.
#[test]
