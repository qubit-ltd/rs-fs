...
/// Rejects a non-atomic provider writer outcome when the caller requires atomic publication.
#[test]
...
/// Retains publication state when abort cleanup confirms success after publication.
#[test]
...
/// Rejects a non-atomic successful temporary persist and retains source cleanup responsibility.
#[test]
...
/// Rejects entries outside the list root and transitions the stream to a terminal state.
#[test]
