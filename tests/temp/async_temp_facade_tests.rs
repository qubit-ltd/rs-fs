...
use qubit_fs::{
    AtomicityRequirement, FsErrorKind, Path, PersistOptions, TempDirectoryOptions, TempFileOptions,
    TempResourceState,
};
...
/// Rejects a provider-created temporary identity before a handle escapes the facade.
#[test]
