...
// =============================================================================
use qubit_fs::{AchievedAtomicity, PublicationMethod, ResourceVersion, UserMetadata, WriteOutcome};

#[test]
fn write_outcome_reports_actual_publication_semantics() {
    let mut outcome = WriteOutcome::new(AchievedAtomicity::Atomic, PublicationMethod::AtomicRename);
