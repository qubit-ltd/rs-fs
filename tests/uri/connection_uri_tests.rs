...
/// Verifies connection URI formatting redacts all sensitive duplicate query values.
#[test]
...
/// Verifies connection rendering preserves a userinfo authority while masking its password.
#[test]
